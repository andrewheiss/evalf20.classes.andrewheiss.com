...
You will lose 1 point per day for each day a problem set is late. This is designed to not be a huge penalty (3 days late = 17/20 points on a problem set that gets a ✓), but instead is a commitment device to help you stay on schedule. 
...
assignments <- tribble(
  ~Points,   ~Assignment,
  10 * 14    , "Weekly check-ins (14 × 10)",
  8 * 30     , "Problem sets (8 × 30)",
