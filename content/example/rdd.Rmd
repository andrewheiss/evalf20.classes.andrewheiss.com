...
tutoring <- tibble(
  ...
  mutate(exit_exam = round(exit_exam * 40 + 10 * tutoring + entrance_exam / 2, 1))

write_csv(tutoring, here::here("static", "data", "tutoring_program.csv"))
```
