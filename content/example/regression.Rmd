...
knitr::opts_chunk$set(fig.width = 6, fig.height = 3.6, fig.align = "center", fig.retina = 3)
set.seed(1234)
...
sat_gpa <- read_csv(here::here("static", "data", "sat_gpa.csv"))
```
