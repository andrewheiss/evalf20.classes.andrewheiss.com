...
3. A CSV file of your fake data.
...
- ~~[<i class="fas fa-external-link-square-alt"></i> Empty RStudio.cloud project](#)~~
- [<i class="fas fa-file-archive"></i> Empty RStudio project you can download and unzip on your computer](/files/final-project.zip) (doesn't include any packages, since you're responsible for installing those)
