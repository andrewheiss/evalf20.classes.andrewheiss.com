...
- Generating random numbers: <https://evalf20.classes.andrewheiss.com/example/random-numbers/>
- The ultimate guide to generating synthetic data for causal inference: <https://evalf20.classes.andrewheiss.com/example/synthetic-data/>
